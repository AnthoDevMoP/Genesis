...
<<<<<<< .mine<<<<<<< .mine    auctionbot.DecrementItemCounts(auction, item_template);
=======bool AuctionHouseObject::RemoveAuction(AuctionEntry* auction, uint32 item_template)
=======bool AuctionHouseObject::RemoveAuction(AuctionEntry* auction, uint32 item_template)
>>>>>>> .theirs{
<<<<<<< .mine>>>>>>> .theirs    auctionbot.DecrementItemCounts(auction, item_template);
=======    auctionbot.DecrementItemCounts(auction, item_template);
>>>>>>> .theirs    bool wasInMap = AuctionsMap.erase(auction->Id) ? true : false;
