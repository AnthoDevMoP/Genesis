...
class spell_gen_full_resistance: public SpellScriptLoader
{
    public:
        spell_gen_full_resistance() : SpellScriptLoader("spell_gen_full_resistance") {}

    class spell_gen_full_resistance_AuraScript: public AuraScript
    {
        PrepareAuraScript(spell_gen_full_resistance_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_gen_full_resistance_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_MOD_RESISTANCE_EXCLUSIVE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_gen_full_resistance_AuraScript();
    }
 };
 
class spell_gen_half_resistance: public SpellScriptLoader
{
    public:
        spell_gen_half_resistance() : SpellScriptLoader("spell_gen_half_resistance") {}

    class spell_gen_half_resistance_AuraScript: public AuraScript
    {
        PrepareAuraScript(spell_gen_half_resistance_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_gen_half_resistance_AuraScript::CalculateAmount, EFFECT_1, SPELL_AURA_MOD_RESISTANCE_EXCLUSIVE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_gen_half_resistance_AuraScript();
    }
 };
/*
...
void AddSC_generic_spell_scripts()
{
    ...
    new spell_gen_full_resistance();
    new spell_gen_half_resistance();
