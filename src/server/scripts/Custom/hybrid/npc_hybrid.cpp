 ...
 * Cataclysm Hybrid
 *
 * By Likan(ChaosDev) - Head Admin end Developer of Gameshoot.eu Server
 */
...
/********** effekty **********/
/********** menu **********/
    player->ADD_GOSSIP_ITEM( 7, "[Specialna Akcia Genesis] ->"                    , GOSSIP_SENDER_MAIN, 10001);
...
case 450:
    player->ADD_GOSSIP_ITEM( 5, "[DK zona] ->"     , GOSSIP_SENDER_MAIN, 8525);
    player->ADD_GOSSIP_ITEM( 5, "[PVP a Dueal zona] ->"                    , GOSSIP_SENDER_MAIN, 9050);
                        player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"                , GOSSIP_SENDER_MAIN, 5552);
...
case 100000000:
    player->ADD_GOSSIP_ITEM( 7, "Pravydla"                    , GOSSIP_SENDER_MAIN, 50800);
                        player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"                , GOSSIP_SENDER_MAIN, 5552);
                                ...
                                break;
case 10001:
    player->ADD_GOSSIP_ITEM( 7, "Level Up 85 Akcia"                    , GOSSIP_SENDER_MAIN, 10002);
    player->ADD_GOSSIP_ITEM( 7, "[DK lvl 85 spell, talents] ->"       , GOSSIP_SENDER_MAIN, 9060);
                        player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"                , GOSSIP_SENDER_MAIN, 5552);
...
/********** maps - Lvl - 1 - 10 **********/
            ...
            case 8103: // Tirisfal Glades
                player->CLOSE_GOSSIP_MENU();
                player->TeleportTo(0, 1767.014282f, 1603.041382f, 109.400269f, 0.0f);
                break;
...
case 10002: //85 lvl 
                    player->CLOSE_GOSSIP_MENU();
                                        ...
                                        player->UpdateSkillsToMaxSkillsForLevel();
                                        player->CastSpell(player,61456,false);
                                        _creature->MonsterSay("Dakujem za viuzitie akcii pozor cas kedy konèi sa bliži :)" ,0 , player->GetGUID());
                                        
                                        break;

case 9050: // -->tu zacnu<--
  player->CLOSE_GOSSIP_MENU();
  player->TeleportTo(1, -2705.87f, -4668.79f, 19.81f, 4.6f);
break;
