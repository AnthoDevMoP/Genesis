...
class npc_vertexpinakle_taxi : public CreatureScript
{
    public:
        npc_vertexpinakle_taxi() : CreatureScript("npc_vertexpinakle_taxi") { }
...

                {
                        ...
                        {
    player->ADD_GOSSIP_ITEM( 5, "Port 1 lokacia"                    , GOSSIP_SENDER_MAIN, 452);
    player->ADD_GOSSIP_ITEM( 5, "Port 2 lokacia"                    , GOSSIP_SENDER_MAIN, 451);          
                  }
...
player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, _creature->GetGUID());
             ...
             case 454: //Back To Main Menu
                        {
    player->ADD_GOSSIP_ITEM( 5, "Port 1 lokacia"                    , GOSSIP_SENDER_MAIN, 451);
    player->ADD_GOSSIP_ITEM( 5, "Port 2 lokacia"                    , GOSSIP_SENDER_MAIN, 452);
                        }
