...
#define TEXT_BEETLE   "A beetle is a family of tenacity pets in World of Warcraft. They like to eat fungus and fruit."
...
#define TEXT_DOG   "A dog is a family of ferocity pets in World of Warcraft. They like to eat meat, fish, cheese, bread, fungus and fruit."
...
#define TEXT_FOX   "A fox is a family of ferocity pets in World of Warcraft. They like to eat meat, fish and fruit."
...
#define TEXT_MONKEY   "A monkey is a family of cunning pets in World of Warcraft. They like to eat fungus and fruit."
...
#define TEXT_SHALE_SPIDER   "A shale spider is a family of exotic tenacity pets in World of Warcraft. They like to eat meat, fish, raw meat and raw fish."
        ...
        npc_petmaster() : CreatureScript("npc_petmaster") { }
	 	...
	 	bool OnGossipHello(Player *player, Creature *_creature)
	       	...
	       	else
			{
	  			...
	  			player->ADD_GOSSIP_ITEM( 6, "Cataclysm"                   , GOSSIP_SENDER_MAIN, 5);
	  	     	}
		    ...
		    if (player->isInCombat())
		    {
			 ...
			 player->PlayerTalkClass->ClearMenus();
				...
				player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"      	     , GOSSIP_SENDER_MAIN, 6);
        		 ...
        		 case 5: //Cataclysm
	  			player->ADD_GOSSIP_ITEM( 1, "Beetle"                         , GOSSIP_SENDER_MAIN, 500);
	  			player->ADD_GOSSIP_ITEM( 1, "Dog"                            , GOSSIP_SENDER_MAIN, 502);
	  			player->ADD_GOSSIP_ITEM( 1, "Fox"                            , GOSSIP_SENDER_MAIN, 503);
	  			player->ADD_GOSSIP_ITEM( 1, "Monkey"                         , GOSSIP_SENDER_MAIN, 504);
	  			player->ADD_GOSSIP_ITEM( 1, "Shale Spider"                   , GOSSIP_SENDER_MAIN, 505);
				player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"      	     , GOSSIP_SENDER_MAIN, 6);
			 	...
			 	break;
     		 		...
     		 		case 500: //Beetle I
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Black"    , GOSSIP_SENDER_MAIN, 5000);
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Gold"     , GOSSIP_SENDER_MAIN, 5001);
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Green"    , GOSSIP_SENDER_MAIN, 5002);
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Purple"   , GOSSIP_SENDER_MAIN, 5003);
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Red"      , GOSSIP_SENDER_MAIN, 5004);
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Tan"      , GOSSIP_SENDER_MAIN, 5005);
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Teal"     , GOSSIP_SENDER_MAIN, 5006);
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab White"    , GOSSIP_SENDER_MAIN, 5007);
					player->ADD_GOSSIP_ITEM( 7, "[Page II] ->"      	      , GOSSIP_SENDER_MAIN, 501);
					...
					player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"           , GOSSIP_SENDER_MAIN, 6);
			 		...
			 		break;
        				...
        				case 5000: //Silithid Scarab Black
            					CreatePet(player, _creature, 8932);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5001: //Silithid Scarab Gold
            					CreatePet(player, _creature, 15621);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5002: //Silithid Scarab Green
            					CreatePet(player, _creature, 3253);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5003: //Silithid Scarab Purple
            					CreatePet(player, _creature, 5459);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5004: //Silithid Scarab Red
            					CreatePet(player, _creature, 10699);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5005: //Silithid Scarab Tan
            					CreatePet(player, _creature, 51674);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5006: //Silithid Scarab Teal
            					CreatePet(player, _creature, 5451);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5007: //Silithid Scarab White
            					CreatePet(player, _creature, 15462);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

     		 		case 501: //Beetle II
	  				player->ADD_GOSSIP_ITEM( 1, "Silithid Scarab Yellow"   , GOSSIP_SENDER_MAIN, 5010);
	  				player->ADD_GOSSIP_ITEM( 1, "Uldum Scarab Blue"        , GOSSIP_SENDER_MAIN, 5011);
	  				player->ADD_GOSSIP_ITEM( 1, "Uldum Scarab Green"       , GOSSIP_SENDER_MAIN, 5012);
	  				player->ADD_GOSSIP_ITEM( 1, "Uldum Scarab Purple"      , GOSSIP_SENDER_MAIN, 5013);
	  				player->ADD_GOSSIP_ITEM( 1, "Uldum Scarab Red"         , GOSSIP_SENDER_MAIN, 5014);
	  				player->ADD_GOSSIP_ITEM( 1, "Uldum Scarab Teal"        , GOSSIP_SENDER_MAIN, 5015);
	  				player->ADD_GOSSIP_ITEM( 1, "Uldum Scarab Yellow"      , GOSSIP_SENDER_MAIN, 5016);
					player->ADD_GOSSIP_ITEM( 7, "<- [Page I]"      	      , GOSSIP_SENDER_MAIN, 500);
					player->ADD_GOSSIP_ITEM( 7, "<- [Back]"      	      , GOSSIP_SENDER_MAIN, 5);
					player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"           , GOSSIP_SENDER_MAIN, 6);
			 		...
			 		break;
        				...
        				case 5010: //Silithid Scarab Yellow
            					CreatePet(player, _creature, 6555);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5011: //Uldum Scarab Blue
            					CreatePet(player, _creature, 40458);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5012: //Uldum Scarab Green
            					CreatePet(player, _creature, 39440);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5013: //Uldum Scarab Purple
            					CreatePet(player, _creature, 46129);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5014: //Uldum Scarab Red
            					CreatePet(player, _creature, 40310);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5015: //Uldum Scarab Teal
            					CreatePet(player, _creature, 46126);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

        				case 5016: //Uldum Scarab Yellow
            					CreatePet(player, _creature, 47801);
                  				_creature->MonsterWhisper(TEXT_BEETLE, player->GetGUID());
           					break;

     		 		case 502: //Dog
	  				player->ADD_GOSSIP_ITEM( 1, "Hound Blue"           , GOSSIP_SENDER_MAIN, 5020);
	  				player->ADD_GOSSIP_ITEM( 1, "Hound Gray"           , GOSSIP_SENDER_MAIN, 5021);
	  				player->ADD_GOSSIP_ITEM( 1, "Hound Purple"         , GOSSIP_SENDER_MAIN, 5022);
	  				player->ADD_GOSSIP_ITEM( 1, "Hound Red"            , GOSSIP_SENDER_MAIN, 5023);
	  				player->ADD_GOSSIP_ITEM( 1, "Hound White"          , GOSSIP_SENDER_MAIN, 5024);
	  				player->ADD_GOSSIP_ITEM( 1, "Mage Hunter Blue"     , GOSSIP_SENDER_MAIN, 5025);
	  				player->ADD_GOSSIP_ITEM( 1, "Mage Hunter Green"    , GOSSIP_SENDER_MAIN, 5026);
	  				player->ADD_GOSSIP_ITEM( 1, "Mage Hunter Red"      , GOSSIP_SENDER_MAIN, 5027);
	  				player->ADD_GOSSIP_ITEM( 1, "Mastiff Black"        , GOSSIP_SENDER_MAIN, 5028);
	  				player->ADD_GOSSIP_ITEM( 1, "Mastiff Gray"         , GOSSIP_SENDER_MAIN, 5029);
	  				player->ADD_GOSSIP_ITEM( 1, "Mastiff Red"          , GOSSIP_SENDER_MAIN, 5030);
	  				player->ADD_GOSSIP_ITEM( 1, "Mastiff Yellow"       , GOSSIP_SENDER_MAIN, 5031);
					player->ADD_GOSSIP_ITEM( 7, "<- [Back]"      	  , GOSSIP_SENDER_MAIN, 5);
					player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"       , GOSSIP_SENDER_MAIN, 6);
			 		...
			 		break;
        				...
        				case 5020: //Hound Blue
            					CreatePet(player, _creature, 1548);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5021: //Hound Gray
            					CreatePet(player, _creature, 22349);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5022: //Hound Purple
            					CreatePet(player, _creature, 10356);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5023: //Hound Red
            					CreatePet(player, _creature, 8921);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5024: //Hound White
            					CreatePet(player, _creature, 30158);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5025: //Mage Hunter Blue
            					CreatePet(player, _creature, 31010);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5026: //Mage Hunter Green
            					CreatePet(player, _creature, 8598);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5027: //Mage Hunter Red
            					CreatePet(player, _creature, 32163);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5028: //Mastiff Black
            					CreatePet(player, _creature, 36405);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5029: //Mastiff Gray
            					CreatePet(player, _creature, 23994);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5030: //Mastiff Red
            					CreatePet(player, _creature, 4304);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

        				case 5031: //Mastiff Yellow
            					CreatePet(player, _creature, 45453);
                  				_creature->MonsterWhisper(TEXT_DOG, player->GetGUID());
           					break;

     		 		case 503: //Fox
	  				player->ADD_GOSSIP_ITEM( 1, "Mist"                , GOSSIP_SENDER_MAIN, 5032);
	  				player->ADD_GOSSIP_ITEM( 1, "Mist Arctic"         , GOSSIP_SENDER_MAIN, 5033);
	  				player->ADD_GOSSIP_ITEM( 1, "Mist Black"          , GOSSIP_SENDER_MAIN, 5034);
	  				player->ADD_GOSSIP_ITEM( 1, "Mist Brown"          , GOSSIP_SENDER_MAIN, 5035);
	  				player->ADD_GOSSIP_ITEM( 1, "Mist Red"            , GOSSIP_SENDER_MAIN, 5036);
					player->ADD_GOSSIP_ITEM( 7, "<- [Back]"      	 , GOSSIP_SENDER_MAIN, 5);
					player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"      , GOSSIP_SENDER_MAIN, 6);
			 		...
			 		break;
        				...
        				case 5032: //Mist
            					CreatePet(player, _creature, 45380);
                  				_creature->MonsterWhisper(TEXT_FOX, player->GetGUID());
           					break;

        				case 5033: //Mist Arctic
            					CreatePet(player, _creature, 49565);
                  				_creature->MonsterWhisper(TEXT_FOX, player->GetGUID());
           					break;

        				case 5034: //Mist Black
            					CreatePet(player, _creature, 43084);
                  				_creature->MonsterWhisper(TEXT_FOX, player->GetGUID());
           					break;

        				case 5035: //Mist Brown
            					CreatePet(player, _creature, 44551);
                  				_creature->MonsterWhisper(TEXT_FOX, player->GetGUID());
           					break;

        				case 5036: //Mist Red
            					CreatePet(player, _creature, 47676);
                  				_creature->MonsterWhisper(TEXT_FOX, player->GetGUID());
           					break;

     		 		case 504: //Monkey
	  				player->ADD_GOSSIP_ITEM( 1, "Black"               , GOSSIP_SENDER_MAIN, 5040);
	  				player->ADD_GOSSIP_ITEM( 1, "Blue"                , GOSSIP_SENDER_MAIN, 5041);
	  				player->ADD_GOSSIP_ITEM( 1, "Brown"               , GOSSIP_SENDER_MAIN, 5042);
	  				player->ADD_GOSSIP_ITEM( 1, "White"               , GOSSIP_SENDER_MAIN, 5043);
					player->ADD_GOSSIP_ITEM( 7, "<- [Back]"      	 , GOSSIP_SENDER_MAIN, 5);
					player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"      , GOSSIP_SENDER_MAIN, 6);
			 		...
			 		break;
        				...
        				case 5040: //Black
            					CreatePet(player, _creature, 34699);
                  				_creature->MonsterWhisper(TEXT_MONKEY, player->GetGUID());
           					break;

        				case 5041: //Blue
            					CreatePet(player, _creature, 48442);
                  				_creature->MonsterWhisper(TEXT_MONKEY, player->GetGUID());
           					break;

        				case 5042: //Brown
            					CreatePet(player, _creature, 48441);
                  				_creature->MonsterWhisper(TEXT_MONKEY, player->GetGUID());
           					break;

        				case 5043: //White
            					CreatePet(player, _creature, 48278);
                  				_creature->MonsterWhisper(TEXT_MONKEY, player->GetGUID());
           					break;

     		 		case 505: //Shale Spider
	  				player->ADD_GOSSIP_ITEM( 1, "Green"               , GOSSIP_SENDER_MAIN, 5050);
	  				player->ADD_GOSSIP_ITEM( 1, "Orange"              , GOSSIP_SENDER_MAIN, 5051);
	  				player->ADD_GOSSIP_ITEM( 1, "Purple"              , GOSSIP_SENDER_MAIN, 5052);
	  				player->ADD_GOSSIP_ITEM( 1, "Red"                 , GOSSIP_SENDER_MAIN, 5053);
					player->ADD_GOSSIP_ITEM( 7, "<- [Back]"      	 , GOSSIP_SENDER_MAIN, 5);
					player->ADD_GOSSIP_ITEM( 7, "<- [Main Menu]"      , GOSSIP_SENDER_MAIN, 6);
			 		...
			 		break;
        				...
        				case 5050: //Green
            					CreatePet(player, _creature, 49822);
                  				_creature->MonsterWhisper(TEXT_SHALE_SPIDER, player->GetGUID());
           					break;

        				case 5051: //Orange
            					CreatePet(player, _creature, 49815);
                  				_creature->MonsterWhisper(TEXT_SHALE_SPIDER, player->GetGUID());
           					break;

        				case 5052: //Purple
            					CreatePet(player, _creature, 47071);
                  				_creature->MonsterWhisper(TEXT_SHALE_SPIDER, player->GetGUID());
           					break;

        				case 5053: //Red
            					CreatePet(player, _creature, 47072);
                  				_creature->MonsterWhisper(TEXT_SHALE_SPIDER, player->GetGUID());
           					break;
